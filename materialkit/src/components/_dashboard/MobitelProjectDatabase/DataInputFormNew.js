...
export default function Testdataforms() {
  ...
  // const handleChange125 = (event) => {
  //   setSub_Contractor_Remarks(event.target.value);
  ...
  // console.log(Sub_Contractor_Status);
  ...
  const sendData = (e) => {
    ...
    if (Sub_Contractor.length !== 0 && Sub_Contractor_Remarks.length !== 0) {
      setSub_Contractor_Status('Completed');
    } else {
      setSub_Contractor_Status('Pending');
    }
