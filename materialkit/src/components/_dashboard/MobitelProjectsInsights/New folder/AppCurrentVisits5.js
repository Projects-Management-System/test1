...
export default function AppCurrentVisits({ mobilizationData }) {
  const theme = useTheme();

  // const [mobilizationData, setData] = useState([]);
  // useEffect(() => {
  //   axios
  //     .get('https://pms-mobitel.herokuapp.com/mobitelProjectsDatabases')
  //     .then((res) => {
  //       setData(res.data.mobilizeDataforFrontEnd);
  //       // console.log(res.data.mobilizeDataforFrontEnd);
  //     })
  //     .catch((err) => {
  //       console.log(err);
  //     });
