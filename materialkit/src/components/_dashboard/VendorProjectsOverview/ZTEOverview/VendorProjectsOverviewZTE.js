...
export default function VendorProjectsOverviewZTE() {
  const [isVisible1, setIsVisible1] = useState(false);

  return (
    <Page title="Vendor Projects Overview - ZTE | Project Management Database">
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={3}>
          <Typography variant="h6" gutterBottom>
            Vendor Projects Overview - ZTE Projects
          </Typography>
