...
export default function AddNewData() {
  ...
  const sendData = (e) => {
    e.preventDefault();
    const newName = { Site_Status };
    axiosInstance
      .post('/SiteStatus/save', newName)
      .then(() => {
        alert('New Site Status Added');
        setSite_Status('');
  ...
  const formik = useFormik({ initialValues: { Site_Status: '' } });
